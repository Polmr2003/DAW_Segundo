...
class CategoryController implements ControllerInterface
{
    ...
    public function processRequest()
    {
        ...
        switch ($request) {
            ...
            case "list_by_id": //opció de menu que trobem a MainMenu.html, menú de la vista que carreguem el primer cop amb el display
                $this->searchById();
                break;
    ...
    {
        $this->view->display("view/form_Category/CategoryList_by_id.php"); //li passem la variable que es diu $template a la vista CategoryView.class.php
    }
